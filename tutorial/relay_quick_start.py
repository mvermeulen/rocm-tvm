...
Notice that you need to build TVM with rocm and llvm enabled.
"""
...
#      :align: center
#
# In this tutorial, we'll choose rocm and llvm as target backends.
...
# into the lower intrinsic IR of the specified target backend, which is ROCM
